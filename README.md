...
└── components.md                 # 컴포넌트 가이드 (예정)
 
💻 개발 문서
/docs/development/
├── tech-decision.md              # 기술 스택 선정 이유
├── db-schema.md                  # DB 스키마
├── folder-structure.md           # 폴더 구조 설명 (예정)
├── coding-convention.md          # 코딩 규칙 (예정)
...
- [폴더 구조](docs/development/folder-structure.md) (예정)
- [코딩 컨벤션](docs/development/coding-convention.md) (예정)
- [API 명세](docs/development/api-spec.md) (예정)
